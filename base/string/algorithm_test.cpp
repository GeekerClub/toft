...
TEST(String, LongestCommonSubstring) {
    toft::StringPiece str1 = "abcd";
    toft::StringPiece str2 = "efg";
    toft::StringPiece str3 = LongestCommonSubstring(str1, str2);
    EXPECT_EQ("", str3);

    str1 = "abcdef";
    str2 = "abcf";
    str3 = LongestCommonSubstring(str1, str2);
    EXPECT_EQ("abc", str3);
