...
public:
    ...
    MOCK_METHOD1(GetSize, int64_t (const std::string& file_path));
    ...
    MOCK_METHOD4(Iterate, FileIterator* (const std::string& dir,
                                         ...
                                         int include_types,
                                         int exclude_types));
    MOCK_METHOD2(Mkdir, bool (const std::string& path, int mode));
    MOCK_METHOD1(Rmdir, bool (const std::string& dir));
