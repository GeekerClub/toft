...
#include "toft/system/atomic/ensure_linked_with_atomic_library.hpp"

namespace toft {

//NOTE(yinhaibo)
//the declaration of EnsureLinkedWithAtomicLibrary function has been moved into
//ensure_linked_with_atomic_library.hpp
//
//#ifdef NDEBUG
