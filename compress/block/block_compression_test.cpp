...
TEST(CompressionTest, GzipCompression) {
    TestCompression("gzip", test_str);
    TestCompression("gzip", test_empty_str);
}

// TEST(CompressionTest, QuicklzCompression) {
//     TestCompression("quicklz", test_str);
//     TestCompression("quicklz", test_empty_str);
// }

TEST(CompressionTest, NoneCompression) {
    TestCompression("none", test_str);
    TestCompression("none", test_empty_str);
}
